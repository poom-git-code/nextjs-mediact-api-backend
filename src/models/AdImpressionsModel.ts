...
export class AdImpressionModel extends Model {
    public id!: number;
    public ad_id!: number;
    ...
    public static associations: {
        ad: Association<AdImpressionModel, AdsModel>;
        ad_media: Association<AdImpressionModel, AdMediaModel>;
    };
}
...
AdImpressionModel.init(
    {
        id: {
            ...
            primaryKey: true,
            allowNull: false,
            comment: 'Unique identifier for the impression',
        },
        ad_id: {
            type: DataTypes.INTEGER,
            allowNull: false,
        ...
        timestamp: {
            ...
            comment: 'Timestamp when the impression occurred',
        },
        viewer_ip: {
    ...
    },
    {
        ...
        comment: 'Stores ad impression events',
    }
);

// AdImpressionModel.belongsTo(AdsModel, {
//     foreignKey: 'ad_id',
//     as: 'ad',
//     targetKey: 'id',
// });

// AdImpressionModel.hasMany(CreditLogModel, {
//     foreignKey: 'ad_impression_id',
//     as: 'credit_log',
//     sourceKey: 'id',
// });

AdImpressionModel.belongsTo(AdMediaModel, {
